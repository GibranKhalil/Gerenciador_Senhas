...
public class ListaLigada {
	...
	public void adicionarNoComeco(Senha novoElemento) {
	...
	public void adicionarNoFinal(Senha novoElemento) {
	...
	public void adicinarNaPosicao(Senha novoElemento, int posicao) {
